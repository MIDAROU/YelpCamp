...
function EditCamp() {
	...
	useEffect(() => {
		dispatch(getcampground(location.pathname.slice(10)));
							...
							<div id="Location">
								...
								<div id="Search">
									<input
										...
										value={InputValue || Campground.Location.Name}
									/>
									<div id="AutoComplete">
										{Search
					...
					<div id="Details">
							...
							<form id="Form">
								...
								<div>
									...
									<input
										...
										defaultValue={Number(Campground.Price)}
								...
								<div>
									...
									<input
										...
										defaultValue={Campground.number}
						...
						<button
							onClick={(e) => {
								...
								data.append("id", Campground._id);
								Imgs &&
									Imgs.forEach((img) => {
										data.append("Imgs", img);
									});
								dispatch(updateCampground(data, navigate));
								setToggleAlert(true);
